		...
		<div className="main">
			...
			<div className='main-projects'>
				<div className='card'>
					...
					<div className='tags'>
						{data.pageProjects.projects[0].stack.map((el: any) => {
							return ( 
								<a href={data.pageProjects.projects[0].link}>{el}</a>
							);
						})}
					</div>
				...
				<div className='card'>
					...
					<div className='tags'>
						{data.pageProjects.projects[1].stack.map((el: any) => {
							return ( 
								<a href={data.pageProjects.projects[1].link}>{el}</a>
							);
						})}
					</div>
				...
				<div className='card'>
					...
					<div className='tags'>
						{data.pageProjects.projects[2].stack.map((el: any) => {
							return ( 
								<a href={data.pageProjects.projects[2].link}>{el}</a>
							);
						})}
					</div>
				...
				<div className='card'>
					...
					<div className='tags'>
						{data.pageProjects.projects[3].stack.map((el: any) => {
							return ( 
								<a href={data.pageProjects.projects[3].link}>{el}</a>
							);
						})}
					</div>
				...
				<div className='card'>
					...
					<div className='tags'>
						{data.pageProjects.projects[4].stack.map((el: any) => {
							return ( 
								<a href={data.pageProjects.projects[4].link}>{el}</a>
							);
						})}
					</div>
				...
				<div className='card'>
					...
					<div className='tags'>
						{data.pageProjects.projects[5].stack.map((el: any) => {
							return ( 
								<a href={data.pageProjects.projects[5].link}>{el}</a>
							);
						})}
					</div>
				...
				<div className='card'>
					...
					<div className='tags'>
						{data.pageProjects.projects[6].stack.map((el: any) => {
							return ( 
								<a href={data.pageProjects.projects[6].link}>{el}</a>
							);
						})}
					</div>
				...
				<div className='card'>
					...
					<div className='tags'>
						{data.pageProjects.projects[7].stack.map((el: any) => {
							return ( 
								<a href={data.pageProjects.projects[7].link}>{el}</a>
							);
						})}
					</div>
				...
				<div className='card'>
					...
					<div className='tags'>
						{data.pageProjects.projects[8].stack.map((el: any) => {
							return ( 
								<a href={data.pageProjects.projects[8].link}>{el}</a>
							);
						})}
					</div>
				...
				<div className='card'>
					...
					<div className='tags'>
						{data.pageProjects.projects[9].stack.map((el: any) => {
							return ( 
								<a href={data.pageProjects.projects[9].link}>{el}</a>
							);
						})}
					</div>
